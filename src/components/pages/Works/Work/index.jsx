    ...
    return (
        <div className={styles.item}>
            ...
            <div className={styles.content}>
                <h3 href="#" className={styles.title}>altermono.com</h3>
                <p className={styles.desc}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Elementum volutpat orci
                ...
                <a className={styles.link} href="#"><Send>Перейти на сайт</Send></a>
            </div>
        </div>
    );
};
